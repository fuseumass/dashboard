namespace :feature_flags do
  ...
  task load_flags: :environment do
    ...
    display_names = { "event_applications" => "Applications", "mentorship_requests" => "Mentorship Requests", "hardware" => "Hardware Requests", "projects" => "Projects", "check_in" => "Check-Ins", "prizes" => "Prizes", "events" => "Schedule"}
