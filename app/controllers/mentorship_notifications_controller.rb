    ...
    respond_to do |format|
      if @mentorship_notification.update(mentorship_notification_params)
        if @mentorship_notification.all
          slack_notify_user(@mentorship_notification.user_id, "You just updated your mentorship request notification preferences. You will be notified for all mentorship requests. Thanks! (Make sure you turn off Slack do not disturb mode and enable notifications!)")
        else
          slack_notify_user(@mentorship_notification.user_id, "You just updated your mentorship request notification preferences. You will be notified for mentorship requests with these tech categories: #{@mentorship_notification.tech}. Thanks! (Make sure you turn off Slack do not disturb mode and enable notifications!)")
        end
